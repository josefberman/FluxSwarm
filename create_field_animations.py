...
def main():
    ...
    parser.add_argument("--run_folder", required=True, help="Path to run folder (e.g., run/2025-1-1_12-30-45)")
    ...
    parser.add_argument("--length_y", type=float, default=2, help="Simulation domain length in y (default: 2)")
