...
# Simulation dimensions are length=μm and time=second
sim = Simulation(length_x=18000, length_y=800, resolution=(6000, 200), dt=0.05, total_time=20)
swarm = Swarm(num_x=5, num_y=5, left_location=12000, bottom_location=80, member_interval_x=200, member_interval_y=160,
              member_radius=25, member_density=2.33E-15)
