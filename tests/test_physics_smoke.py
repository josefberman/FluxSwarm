"""Physics smoke tests (PhiFlow). Marked so they can be skipped if GPU unavailable."""
...
def test_env_reset_step_shapes(tiny_cfg):
    ...
    actions = np_actions = __import__("numpy").zeros((2, 4, 2), dtype="float64")
    actions[..., 0] = -1.0
